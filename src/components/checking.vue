        ...
        <ul>
          <li>
            <!-- <div class="top single">
              <p class="text">计划考勤人数</p>
              <p class="num" v-show="info&&info.planNum" v-text="info.planNum"></p>
              <em class="num" v-show="!info || !info.planNum">0</em>
            </div> -->
            <div class="top">
              <div class="item">
                <span class="text">派工人数(白)</span>
                <em class="num" v-show="info&&info.planNum" v-text="info.planNum"></em>
                <em class="num" v-show="!info || !info.planNum">0</em>
              </div>
              <div class="item">
                <span class="text">派工人数(夜)</span>
                <em class="num" v-show="info&&info.recordTime" style="letter-spacing:-3px;">{{Math.round(info.recordTime*10)/10}}</em>
          ...
          <li>
            <div class="top single">
              ...
              <p class="num" v-show="info&&info.onWorkTime">{{Math.round(info.onWorkTime*10)/10}}h</p>
...
<script>
  ...
  // import BScroll from 'better-scroll'
    ...
    data () {
	  ...
	  computed: {},
    created () {
      // $('#checking_list-cameramap').resize(function (e) {
      //   console.log(1111111111)
      //   var $divWidth = $('.checking_list-cameramap').width()
   ...
   methods: {
    ...
    getCameraProInfo (workname,workno) {
      // console.log(workname,workno)
       this.$http.post('/sanyUserPushRecord/searchUserRecordHis', {
         workname:workname,
         workno:workno
       })
         .then((response) => {
...
.checking{
  ...
  &_dashbordBox{
    ...
    .home_title{
      ...
      .checking_total{
        font-size:24px;color:#fff;position: absolute;right:0;top:-10px;font-weight:100;
        em{font-size:42px;color:#01cbff;display: inline-block;vertical-align: -6px;margin-left:12px;font-family: fontnameRegular;}
      }
    }
  }
  &_dashbord{
    ...
    ul{
      ...
      li{
        ...
        .text{font-size:22px;font-weight:100;}
        .num{font-size:35px;color:#02c9fc;font-family: fontnameRegular;}
        ...
        .lvText{color:#c4c4c4;font-size:18px;}
        .top{
          height:90px;overflow: hidden;text-align:left;
          .item{
  ...
  &_list{
    ...
    &-search{
      ...
      &>input{
        ...
        border-radius:5px ;
        margin-right: 20px;font-size:14px;float:left;
      }
    ...
    &-bottom{
      height: calc(100% - 88px);width:100%;
      .off{display: none;}
    }
    &-time{
